...
import fr.cl.musicsearch.search.SearchBuilder
 ...
 */
class RootBuilder(dependency: ParentComponent) : ViewBuilder<RootView,
        RootRouter, RootBuilder.ParentComponent>(dependency) {
    ...
    abstract class Module {
        ...
        companion object {
            ...
            @Provides
            @JvmStatic
            fun searchListener(rootInteractor: RootInteractor): SearchInteractor.ListenerSearch {
                return rootInteractor.SearchListener()
            }
            ...
            internal fun router(
                ...
                return RootRouter(view, interactor, component,
                    SearchScreen(SearchBuilder(component)),
                    ViewScreen(fr.cl.musicsearch.view.ViewBuilder(component)),
                    fr.cl.musicsearch.view.ViewBuilder(component),
                    screenStack)
            }
            ...
            internal fun screenStack(rootView: RootView): ScreenStack {
                return ScreenStack(rootView.viewContainer())
            }
        }
    ...
    interface Component : InteractorBaseComponent<RootInteractor>,
        ...
        fr.cl.musicsearch.view.ViewBuilder.ParentComponent,
        BuilderComponent {
